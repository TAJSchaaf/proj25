...
section_mapping = c(
  ...
  "Foreword" = "0 Foreword", 
  "White House Office" = "1.01 White House Office", 
  ...
  "Agency for International Development" = "2.06 International Development",
  "Department of Defense" = "2.01 Defense",
  "Department of Homeland Security" = "2.02 Homeland Security",
  "Intelligence Community" = "2.04 Intelligence Community",
  "Department of Labor and Related Agencies" = "3.09 Labor and Related Agencies",
  "Department of State" = "2.03 State",
  "Department of Justice" = "3.08 Justice",
  "Department of Commerce" = "4.01 Commerce",
  "Environmental Protection Agency" = "3.04 Environmental Protection",
  "Department of the Treasury" = "4.02 Treasury",
  "Executive Office of the President of the United States" = "1.02 Executive Office",
  "Department of the Interior" = "3.07 Interior",
  "Department of Transportation" = "3.10 Transportation",
  "Department of Agriculture" = "3.01 Agriculture",
  "Central Personnel Agencies: Managing the Bureaucracy" = "1.03 Central Personnel Agencies",
  "Media Agencies" = "2.05 Media",
